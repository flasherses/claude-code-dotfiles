...
[Example: "Contract Review MCP Server — exposes contract review capabilities
as standardized MCP tools for AI Agents. A streamlined standalone version of
aicontractreview-backend (Redis, SSO, cloud storage, frontend removed)."]
